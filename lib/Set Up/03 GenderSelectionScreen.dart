              ...
              child: Column(
                children: [
                  _buildGenderOption(
                    ...
                    gender: 'Male',
                    icon: Icons.male,
                    circleColor: selectedGender == 'Male' ? Colors.white : Colors.transparent,
                    iconColor: selectedGender == 'Male' ? Colors.black : Colors.white,
                    textColor: textColor,
                    borderColor: selectedGender == 'Male' ? Colors.white : Colors.grey,
                  ),
                  ...
                  _buildGenderOption(
                    ...
                    gender: 'Female',
                    icon: Icons.female,
                    circleColor: selectedGender == 'Female' ? femaleCircleColor : Colors.transparent,
                    iconColor: selectedGender == 'Female' ? Colors.black : Colors.white,
                    textColor: textColor,
                    borderColor: selectedGender == 'Female' ? femaleCircleColor : Colors.grey,
                  ),
                ],
              ),
            ),
                ...
                onPressed: () async {
                  if (selectedGender != null) {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const HeightSelectionScreen(gender: '',),
                      ),
                    );
                  } else {
                    ScaffoldMessenger.of(context).showSnackBar(
